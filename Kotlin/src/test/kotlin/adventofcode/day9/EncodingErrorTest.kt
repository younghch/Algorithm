...
class EncodingErrorTest {
    ...
    fun findContiguousList() {
        ...
        val contiguousList = listOf(15L, 25L, 47L, 40L)
        Assertions.assertThat(EncodingError.findContiguousList(numbers, 127L)).isEqualTo(contiguousList)
    }
}